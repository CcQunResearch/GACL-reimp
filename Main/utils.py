...
def create_log_dict(args):
    ...
    log_dict['bert_path'] = args.bert_path

    log_dict['droprate'] = args.droprate
    log_dict['join_source'] = args.join_source
    log_dict['mask_source'] = args.mask_source
    log_dict['drop_mask_rate'] = args.drop_mask_rate
    ...
    log_dict['epsilon'] = args.epsilon
    log_dict['lamda'] = args.lamda
    log_dict['lamda_ad'] = args.lamda_ad
